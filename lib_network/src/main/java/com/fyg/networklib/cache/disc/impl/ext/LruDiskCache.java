 ...
 *******************************************************************************/
package com.fyg.networklib.cache.disc.impl.ext;

import android.graphics.Bitmap;

import com.fyg.networklib.cache.disc.DiskCache;
import com.fyg.networklib.cache.disc.naming.FileNameGenerator;
...
public class LruDiskCache implements DiskCache {
     ...
     * @param fileNameGenerator {for cached files. Generated names must match the regex
    ...
    @Override
    public boolean save(String imageUri, InputStream inputStream, IoUtils.CopyListener listener) throws IOException {
    ...
    @Override
    public boolean save(String imageUri, InputStream inputStream) throws IOException {
        DiskLruCache.Editor editor = cache.edit(getKey(imageUri));
        if (editor == null) {
            return false;
        }
